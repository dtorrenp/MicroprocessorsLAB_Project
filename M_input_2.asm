...
Store_Input_2_Setup	    ;setup of serial output
    ...
    movlw	0x00;set the initla memory address to 0x040000
...
Storage_Clear2;clear the second section of the memory
   call	fon
   call	clear_2setup
   call	clear_2
   call	foff
...
clear_2 ;clear the second section of FRAM 
   ...
   movlw	0xFD;compare current memory address against upper limit of the second section of the FRAM 
   cpfsgt	in2_storage_low
   goto		clear_2
   movlw	0xFF
   cpfseq	in2_storage_high
